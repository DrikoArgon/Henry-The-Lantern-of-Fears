...
-(void)attackPlayer:(Henry *)henry
{
    ...
    SKAction *sequence = [SKAction sequence:@[[SKAction rotateByAngle:M_PI duration:2], [SKAction moveBy:CGVectorMake(-(self.position.x - henry.position.x),-(self.position.y - henry.position.y)) duration:100],[SKAction moveBy:CGVectorMake(0,0) duration:0]]];
